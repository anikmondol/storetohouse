                            ...
                            <div class="col-lg-6">
                                <div class="mt-3">
                                    ...
                                    <select name="item_unit" class="form-select @error('item_unit') is-invalid @enderror">
                                        ...
                                        <option value="pcs" {{ old('item_unit') == 'pcs' ? 'selected' : '' }}>pcs
                                        </option>
                                        <option value="kg" {{ old('item_unit') == 'kg' ? 'selected' : '' }}>kg</option>
                                        <option value="litre" {{ old('item_unit') == 'litre' ? 'selected' : '' }}>litre
                                        </option>
                                    </select>
                                    @error('item_unit')
                                        <span class="invalid-feedback text-danger"><strong>{{ $message }}</strong></span>
