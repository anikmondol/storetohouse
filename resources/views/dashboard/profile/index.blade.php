            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('home.profile.password.update') }}" method="POST">
                        ...
                        is-invalid
                        @enderror"
                                id="floatingnameInput" placeholder="Enter Name" name="current_password"
                        ...
                        is-invalid
                        @enderror"
                                id="floatingnameInput" placeholder="Enter Name" name="password"
                                value="{{ old('password') }}">
                        ...
                        is-invalid
                        @enderror"
                                id="floatingnameInput" placeholder="Enter Name" name="password_confirmation"
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('home.profile.image.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-md-10">
                                <input type="file" id="floatingnameInput"
